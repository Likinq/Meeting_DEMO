    ...
    <div>
        <el-row class="tac">
            ...
            <el-menu
                ...
                <el-menu-item index="/PlatformM/Inquire">
                    <template #title>
                        <el-icon><House /></el-icon>
                        <router-link to="/PlatformM/Inquire">会议室查询</router-link>
                    </template>
                </el-menu-item> 
                
                <el-menu-item index="/PlatformM/MeetingList">
                    <template #title>
                        <el-icon><Document /></el-icon>
                        <router-link to="/PlatformM/MeetingList">部门会议列表</router-link>
                    </template>
                </el-menu-item>
                ...
                <el-sub-menu index="2">
                    ...
                    <el-menu-item index="/PlatformM/Booking">
                        <router-link to="/PlatformM/Booking">预约会议</router-link>
                    </el-menu-item>                                        
                    <el-menu-item index="/PlatformM/Review">
                        <router-link to="/PlatformM/Review">待审核</router-link>
                    </el-menu-item>
                </el-sub-menu>
                ...
                <el-sub-menu index="3">
                    ...
                    <el-menu-item index="/PlatformM/SendEmail">
                        <router-link to="/PlatformM/SendEmail">发送信息</router-link>
                    </el-menu-item>
                    <el-menu-item index="/PlatformM/ReceiveEmail">
                        <router-link to="/PlatformM/ReceiveEmail">收到信息</router-link>
                    </el-menu-item>
                </el-sub-menu>                
            </el-menu>
            </el-col>
